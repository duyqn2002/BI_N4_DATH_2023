...
--   InvoiceID_SK int FOREIGN KEY REFERENCES Invoices(InvoiceID_SK),
--   ProductID_SK int FOREIGN KEY REFERENCES Product(ProductID_SK),
--   Quantity INT,
--   DateKey int,
--   Time TIME,
...
--   GrossMarginPct DECIMAL(4,2),
--   TaxPct float,
--   PRIMARY KEY(InvoiceID_SK,ProductID_SK)
-- );
...
select count(distinct(InvoiceID_SK)) from Invoices
select * from Invoices where InvoiceID_SK = 1
select * from Product where ProductID_SK = 285
